...
export const medicalAssets = {
  ...
  servicesDecor: medicalAsset('service-image-74.png'),
  ...
  whyMain: medicalAsset('why-main-australian-cattle-dog.jpg'),
...
const doctorRows = [
  [
    'Bs. Trần Văn Nhân',
    'Kinh nghiệm 20 năm',
    'Tốt nghiệp Trường Đại Học Nông Lâm, ĐHQG TPHCM',
  ],
  [
    'Bs. Võ Công Nam',
    'Kinh nghiệm 14 năm',
  ...
  [
    'Bs. Nguyễn Thu Hồng',
    'Kinh nghiệm 5 năm',
    'Tốt nghiệp Trường Đại học Công Nghệ TPHCM',
  ],
  [
    'Bs. Trần Phương Trâm',
    'Kinh nghiệm 7 năm',
