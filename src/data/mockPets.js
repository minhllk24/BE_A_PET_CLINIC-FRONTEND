export const MOCK_PETS = [
  {
    ...
    medicalRecords: [
      ...
      },
      {
        ...
        doctor: "Trần Thị Lan",
        notes: "Tiêm chủng vaccine ngừa bệnh dại định kỳ năm 2026. Bé hợp tác tốt, kiểm tra sau tiêm 30 phút không có dấu hiệu sốt phản vệ hay sưng đau.",
