...
const INITIAL_EVENTS = [
  { id: 1, day: 3, title: "Uống thuốc", type: "green", icon: "medical", time: "08:00 SA", files: [] },
  { 
    id: 2, 
    day: 9, 
    title: "Khám định kỳ", 
    ...
    time: "09:00 SA",
    files: [
      { id: 'f1', name: "SieuAm.pdf", size: "2.1 MB" },
      { id: 'f2', name: "XetNghiemMau.png", size: "1.5 MB" }
    ]
  },
  { id: 3, day: 9, title: "Cắt móng", type: "blue", icon: "scissors", time: "02:30 CH", files: [] },
  { id: 4, day: 15, title: "Tiêm dại", type: "red", icon: "vaccine", time: "10:00 SA", files: [] },
];
        ...
        <div className="grid gap-5 lg:grid-cols-[380px_1fr] items-start flex-1">
          ...
          <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm flex flex-col h-full">
            ...
            <div className="mt-4 flex justify-end gap-3 flex-shrink-0">
              <Link to={`/my-pets/${pet.id}/edit`} className="flex-shrink-0">
