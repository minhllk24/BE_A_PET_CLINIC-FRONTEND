...
function MedicalHero() {
  return (
    <section className="medical-hero">
      <img className="medical-hero__bg" src={medicalAssets.heroBg} alt="" />
      <div className="medical-hero__copy">
        <h1>Dịch vụ<br />Khám &amp; Điều trị</h1>
        <p>
        ...
        <div className="medical-hero__actions">
          <div className="medical-hero__booking">
            <img src={medicalAssets.heroPaw} alt="" />
  ...
  return (
    <section className="medical-services">
      <div className="medical-section-title medical-services__title">
        <h2>Dịch vụ<br />chúng tôi cung cấp</h2>
      ...
      <div className="medical-services__grid">
        {medicalServices.map((service, index) => (
          <article className="medical-service-card" key={service.title}>
            ...
            <div className="medical-service-card__number">
              <span>{index + 1}</span>
            </div>
...
function MedicalWhy() {
  return (
    <section className="medical-why">
      ...
      <div className="medical-why__layout">
        ...
        <div className="medical-why__main">
          ...
          <div className="medical-why__main-photo">
            <img src={medicalAssets.whyMain} alt="Đội ngũ bác sĩ chăm sóc thú cưng" />
          </div>
        </div>
        <div className="medical-why__column">
      ...
      <img className="medical-why__decor medical-why__decor--paw" src={medicalAssets.whyPaw} alt="" />
      <img className="medical-why__decor medical-why__decor--group-left" src={medicalAssets.whyGroupLeft} alt="" />
      <img className="medical-why__decor medical-why__decor--group-right" src={medicalAssets.whyGroupRight} alt="" />
      <img className="medical-why__decor medical-why__decor--vector" src={medicalAssets.whyVector} alt="" />
      <img className="medical-why__decor medical-why__decor--vector-1" src={medicalAssets.whyVector1} alt="" />
      <img className="medical-why__decor medical-why__decor--vector-2" src={medicalAssets.whyVector2} alt="" />
      <img className="medical-why__decor medical-why__decor--vector-3" src={medicalAssets.whyVector3} alt="" />
      <img className="medical-why__decor medical-why__decor--vector-4" src={medicalAssets.whyVector4} alt="" />
...
function MedicalDoctors() {
  ...
  const move = useCallback(
    (amount) => setPage((current) => (current + amount + medicalDoctorPages.length) % medicalDoctorPages.length),
    [],
  );

  return (
    <section className="medical-doctors" aria-label="Đội ngũ bác sĩ thú y">
      <img className="medical-doctors__bg" src={medicalAssets.doctorsBg} alt="" />
      <img className="medical-doctors__shape" src={medicalAssets.doctorsShape} alt="" />
      <header>
        <h2>
          Đội ngũ <span>bác sĩ thú y<img src={medicalAssets.doctorsUnderline} alt="" /></span>
        </h2>
        <p>
      ...
      <button type="button" className="medical-doctors__arrow medical-doctors__arrow--left" onClick={() => move(-1)} aria-label="Trang bác sĩ trước">‹</button>
      ...
      <button type="button" className="medical-doctors__arrow medical-doctors__arrow--right" onClick={() => move(1)} aria-label="Trang bác sĩ tiếp">›</button>
      <div className="medical-doctors__dots" role="tablist" aria-label="Chọn trang bác sĩ">
