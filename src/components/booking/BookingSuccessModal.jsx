...
function BookingSuccessModal() {
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-[#06105a33] p-5 backdrop-blur-md">
      <div
        className="flex min-h-[310px] w-full max-w-[320px] flex-col items-center justify-center gap-6 rounded-[10px] border border-slate-300 bg-white bg-cover bg-center p-6 text-center shadow-2xl md:max-w-[688px] md:gap-8 md:p-10 lg:max-w-4xl"
        style={{ backgroundImage: `url(${successPanelBackground})` }}
      >
        <img src={successCheckGroup} alt="" className="h-[69px] w-[69px]" />
        <div>
          <h2 className="text-3xl font-bold text-[#3d3d3d] md:text-5xl">Đặt lịch thành công</h2>
        ...
        <div className="flex flex-col justify-center gap-3 md:flex-row md:flex-wrap md:gap-5">
